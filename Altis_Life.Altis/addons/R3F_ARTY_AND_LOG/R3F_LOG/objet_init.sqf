...
//BD
if ({_objet isKindOf _x && (player isKindOf "I_Soldier_repair_F" || {side player == WEST})} count R3F_LOG_CFG_objets_deplacables > 0) then
{
...
//BD
if ({_objet isKindOf _x && (player isKindOf "I_Soldier_repair_F" || player isKindOf "I_medic_F" || side player == WEST)} count R3F_LOG_CFG_objets_remorquables > 0) then
{
