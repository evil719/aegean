...
player createDiarySubject ["aegaenlife","Aegaen Life"];
...
*/
	...
	player createDiaryRecord["changelog",
		[
			"Aegean Life Change Log",
				"
					Check our website for changelog, www.aegeanlife.net
				"
		]
	];
		...
		[
			"Exploits", 
				...
				6. Report exploiters and hackers to an admin immediately or request a ban via our forums.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord["safezones",
		[
			"Safe Zones",
				"
					If bombing (inclusing intentionally exploding a vehicle), robbing, or killing occurs in or around the following areas, it is punishable by ban.<br/><br/>
					
					Any vehicle spawn (shop or garage)<br/>
					Any weapon shop<br/>
					All Police HQs<br/>
					Any medical clinics or hospitals <br/>
					Rebel Outposts<br/>
					Donator Shops<br/><br/>
				"
		]
	...
	player createDiaryRecord ["serverrules",
		[
			"Bannable Offenses", 
				...
				5. Killing in Safe Zones (See 'Safe Zones') <br/>
				6. Griefing <br/>
				7. Other violations regarding RDMing and other rules as found on our forums.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Boats", 
				...
				1. Repeatedly pushing boats without permission or ramming a boat to damage it.<br/>
				2. Pushing a boat with the intention of hurting or killing someone. This is not RP.<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"Aviation", 
				...
				3. Stealing helicopters without proper warning and significant time for the driver to lock the vehicle. If they land and run away without locking, fine. If they just get out and you get in before they get a chance to lock it, no no.<br/>
				4. Flying extremely close and in a dangerous manner near other aircraft in an attempt to obstruct or harrass.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Vehicles", 
				...
				7. The only reason for shooting at a vehicle would be to disable it and/or fire warning shots in a role-play scenario. You are not to deliberately destroy enemies vehicles.<br/>
				8. Stealing vehicles without proper warning and adequate time for the driver to lock the vehicle. If they park and run away without locking, fine. If they just get out and you get in before they get a chance to lock it, no no!<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Communication Rules", 
				...
				3. Those playing as police in this server, whether they are whitelisted or public slots, must be in the server's team speak.
	...
	player createDiaryRecord ["serverrules",
		[
			"New Life Rule", 
				...
				1. If you are a civilian and are killed you must wait 15 minutes before returning to the scene of your death. If you are a cop, you must wait 5 minutes before returning.<br/>
				2. If you die during roleplay your past crimes (including warrants) are forgotten, but you also cannot seek revenge.<br/>
				3. If you are RDM'd, it is not a new life.<br/>
				4. If you manually respawn / combat log, it is not a new life. 'Also bannable offense'<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"Donator Rules",
				"
				Donator's are not to give out any of the items they get, inculding vehilces, weapons, or attachments.<br/>
				"
		]
	];
...
// Aegean Life Section
	...
	player createDiaryRecord ["aegaenlife",
		[
			"Teamspeak",
				"
				Aegean Life's Teamspeak can be found at:<br/><br/>
				198.58.118.146<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["aegaenlife",
		[
			"Website/Forums",
				"
				www.aegeanlife.net<br/>
				This is also where ban appeals, application for cops, and other requests will be made.<br/><br/>
				"
		]
	];
...
// Police Section
	player createDiaryRecord ["policerules",
		[
			"Crisis Negotiation",
				"
				Crisis Negotiation must be handled by a Sergeant or higher. If one is not available, the person with the next highest rank must handle the situation.If the police are unable to begin an negotiation because they are being fired upon, no negotion is required or will be made.<br/><br/>
				"
		]
	];
	player createDiaryRecord ["policerules",
		[
			"Aegean Bank",
				"
				1. Helicopters flying over the bank may be asked to leave and disabled if they refuse.<br/>
				2. If the bank is getting robbed, it is encouraged that all available officers move in to stop it.<br/>
				...
				9. To be able to rob the bank, there has to be at least 5 cops online, 2 of them must be whitelisted.<br/><br/>
				"
		]
	];
	player createDiaryRecord ["policerules",
		[
			"Aviation",
				...
				3. Police may temporarily forbid landing at certain locations for safety and security reasons of the public but it cannot remain closed for a long period of time.<br/>
				...
				6. Police may use helicopters in their routine patrol across the country as needed.<br/><br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Patrolling", 
				...
				2. Patrols can be done on foot, by vehicle, by aircraft, or by vessels.<br/>
				3. Patrols do not include camping at illegal areas except when there has been a specific crime tip from the public about illegal activity regarding that specific illegal area. See 'Raiding/Camping'.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Vehicles", 
				...
				2. Vehicles that look abandoned, broken, with no driver, can be impounded. A search should be done to legally inventory the vehicle before it is impounded.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Speeding", 
				...
				60kph on small urban streets<br/>
				80kph on major urban roads<br/>
				110kph in all other locations<br/>
				* Impeding the flow of traffic and wreckless driving will result in a suitable punishments<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"City Protocol", 
				"
				1. Officers may patrol major cities - Kavala, Athira, Pyrgos and Sofia. They may patrol as part of moving between major cities.<br/>
				...
				6. The Police HQ buildings are illegal for civilians to enter without authorization, however it is NOT illegal for civilians to be nearby unless they are causing a nuisance. Killing inside the police station is a bannable offence.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Arresting and Ticketing",
				...
				1. You may not arrest someone if you have given them a ticket and they paid it. Except in situations as noted in the 'tickets and fines' thread in the forum. <br/>
				...
				1. Tickets must be a reasonable price as determined and listed in the 'tickets and fines' thread in the forums.<br/>
				...
				The list is available at www.aegeanlife.net<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Weapons", 
				...
				1. Civilians are not allowed to have a weapon out within the town limits. If one is visibly in their possession, an officer has the right to conduct a license search.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Raiding/Camping",
				...
				1. In order to raid an area, the cops must have at least 4 officers involved, one of which must be a Sergeant or above. If a Sergeant is not available, the next ranking officer must be leading.<br/>
				...
				8. If the raid is a failure (All officers die), the 15 minute (new life rule) timer still applies to those officers.<br/>
				...
				3. Camping of illegal areas is staying longer than needed after a raid, or if officers do not conduct a raid but continue to watch and take action against civilians entering the area. Exception is when the officers are conducting a sting operation based off of a recent tip of a civilian regarding that exact illegal area.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Chain of Command",
				...
				1. Police Captain / Sheriff<br/>
				2. Police Lieutenant / Chief Deputy Sheriff <br/>
				3. Police Sergeant / ---<br/>
				4. Police Officer / Sheriff Deputy<br/>
				5. Cadet / Cadet<br/><br/>

				Cops in game who are not enrolled/accepted into the PD/SD (public slots) are the lowest tier and have no say in police operations.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Use of Lethal Force",
				...
				2. Discharging of a weapon when not under threat or not during training exercises is not allowed. Officers caught in violation of this rule will be removed from the server and suspended from the APD.<br/>
				3. Failure to follow proper weapons discipline and procedure will get you removed from the server and suspended from the APD.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["illegalitems",
		[
			"Gang Rules",
				...
				2. Being in a gang area is not illegal. Only when partaking in illegal activities. If gang areas are declared by a gang, they must be marked on the map for everyone to see (side chat).<br/>
	...
	player createDiaryRecord ["illegalitems",
		[
			"Illegal Vehicles",
				...
				2. Speedboat<br/>
				3. Hunter<br/>
				4. Any Police/Sheriff vehicle<br/>
				"
		]
	];
	player createDiaryRecord ["illegalitems",
		[
			"Illegal Weapons",
				...
				9. Any explosives/launchers<br/><br/>
				"
		]
	];
	player createDiaryRecord ["illegalitems",
...
// Controls Section
    ...
    player createDiaryRecord ["controls",
        [
			...
			Left Shift + R: Surrender(Civ Only)<br/>
			Left Shift + G: Rob(Civ Only)<br/>
            "
        ]
    ];