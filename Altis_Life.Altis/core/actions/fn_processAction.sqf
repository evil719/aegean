...
_itemInfo = switch (_type) do
{
	...
	case "diamond": {["diamond","diamondc",1350,"Cutting Diamond"]};
	case "heroin": {["heroinu","heroinp",2100,"Cooking Heroin"]};
	case "copper": {["copperore","copper_r",750,"Smelting Copper"]};
	case "iron": {["ironore","iron_r",1120,"Smelthing Iron"]};
	case "sand": {["sand","glass",650,"Processing Sand"]};
	case "salt": {["salt","salt_r",450,"Processing Salt"]};
	case "cocaine": {["cocaine","cocainep",1500,"Cooking Cocaine"]};
	case "marijuana": {["cannabis","marijuana",500,"Processing Marijuana"]};
	case "cement": {["rock","cement",350,"Mixing Cement"]};
	case "tin": {["tinore","tinbar",350,"Smelting Tin"]};
	case "bronze": {[["tinore","copperire"],"bronzebar",850,"Smelthing Bronze"]};
	case "meth": {[["ammonia","lithium","sudafed"],"meth",1800,"Cooking Meth"]};
	default {[]};
};
