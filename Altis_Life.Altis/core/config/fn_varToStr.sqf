...
switch (_var) do
{
    ...
    case "life_inv_tinore": {"Tin Ore"};
    case "life_inv_tinbar": {"Tin Bar"};
    case "life_inv_bronzebar": {"Bronze Bar"};
    case "life_inv_tacos": {"Tacos"};
    case "life_inv_pizza": {"Pizza"};
	case "life_inv_ammonia": {"Ammonia Hydroxide"};
    ...
    case "license_civ_tin": {"Tin Processing"};
    case "license_civ_bronze": {"Smeltery License"};
