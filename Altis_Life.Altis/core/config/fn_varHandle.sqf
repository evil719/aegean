...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
            ...
            case "tinore": {"life_inv_tinore"};
            case "tinbar": {"life_inv_tinbar"};
            case "bronzebar": {"life_inv_bronzebar"};
            case "tacos": {"life_inv_tacos"};
            case "pizza": {"life_inv_pizza"};
			case "ammonia": {"life_inv_ammonia"};
			case "lithium": {"life_inv_lith"};
			case "sudafed": {"life_inv_sudafed"};
	...
	case 1:
	{
		switch (_var) do
		{
            ...
            case "life_inv_tinore": {"tinore"};
            case "life_inv_tinbar": {"tinbar"};
            case "life_inv_bronzebar": {"bronzebar"};
            case "life_inv_tacos": {"tacos"};
            case "life_inv_pizza": {"pizza"};
			case "life_inv_ammonia": {"ammonia"};
			case "life_inv_lith": {"lithium"};
			case "life_inv_sudafed": {"sudafed"};
