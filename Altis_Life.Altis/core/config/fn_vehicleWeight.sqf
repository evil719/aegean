...
switch ((typeOf _vehicle)) do
{
	...
	case "C_Van_01_transport_F": {_weight = 125;};
	case "I_G_Van_01_transport_F": {_weight = 125;};
	case "C_Van_01_box_F": {_weight = 175;};
    ...
    case "I_Heli_Light_03_unarmed_F": {_weight = 65;};
    case "I_Heli_Light_03_F": {_weight = 65;};
	case "B_Heli_Light_01_armed_F": {_weight = 65;};
};
